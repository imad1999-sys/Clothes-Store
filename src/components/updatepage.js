...
const Updatepage = (props) => {
  ...
  useEffect(async () => {
    let result = await fetch(
      "http://127.0.0.1:8000/api/categorieById/" + props.match.params.id
    );
    ...
    setPrice(data.price);
    setImage(data.image);
    setTypeOfFashion(data.type_of_fashion);
  }, []);
  async function updateCategory(id) {
    ...
    let result = await fetch(
      "http://127.0.0.1:8000/api/updateCategorie/" + id,
      {
        method: "PUT",
        body: item,
      }
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="card-body">
                        <h5 className="card-title">Update Categorie</h5>
                        <div>
                          ...
                          <div className="input-group">
                            ...
                            <input
                              defaultValue={data.type_of_fashion}
                              type="text"
                              className="form-control"
